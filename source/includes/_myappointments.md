...
## Get First Completed/Canceled Appointment 

```shell
curl -i -H "Content-Type: application/json" -H "X-Auth-Token:nitesh.yadav@cupertinosoft.com:doctor:1516208048648:27ecd079dffdd0f3d0535865008fba0f" -X GET "http://api.endpoint.eyecarelive.com/DoctorOnDemand/api/doctor/appointment/firstTen/completecancel"
```

```shell
curl -i -H "Content-Type: application/json" -H "X-Auth-Token:nitesh.yadav@cooldoctors.io:doctor:1516455482760:291c9fc74e924a2c5c4c4310dc73c1bc" -X GET "http://api.endpoint.eyecarelive.com/DoctorOnDemand/api/doctor/appointment/nextTen/1/completecancel"
```
      ...
      "familyMembers": [
        {
          ...
          "loginStatus": null,
          "stripeCustId": null,
          "profileImagePath": "https://eyes.cooldoctors.io/PRDIMAGE/patient/57fbc8f9e4b0a73bcaeb22eb/ProfileImage/FamilyPro_img_349887.jpg",
          "isReferredDoctor": null,
          "randomtoken": null,
          "isEmailVerified": false,
          "doctorsGroups": null,
      ...
      "insurenceCards": [
        {
          "name": "cool",
          "files": [
            "1475740716507,https://s3.amazonaws.com/test-nakul/patient/5742c31ae4b0e03acf77f054/insurencecard/1475740716507/img_366725front.jpg",
            "1475740716603,https://s3.amazonaws.com/test-nakul/patient/5742c31ae4b0e03acf77f054/insurencecard/1475740716603/img_906231dback.jpg"
          ],
          "memberId": null,
          "payerId": null
        }
...
`GET
http://localhost:8080/DoctorOnDemand/api/doctor/appointment/firstTen/completecancel
`

`GET
http://localhost:8080/DoctorOnDemand/api/doctor/appointment/nextTen/{NumberOfPage}/completecancel
`
...
--------- | ------------ | ---- | ----------------
Use URL | Use URL to get Completed & Canceled Appointments. | String | Required
